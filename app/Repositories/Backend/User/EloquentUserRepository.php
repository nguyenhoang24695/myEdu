...
class EloquentUserRepository implements UserContract {
	...
	public function getUsersBecometeacherPaginated($per_page, $status = 1, $order_by = 'id', $sort = 'asc'){
		return User::where('status', $status)->where('become_teacher',1)->orderBy($order_by, $sort)->paginate($per_page);
	}
