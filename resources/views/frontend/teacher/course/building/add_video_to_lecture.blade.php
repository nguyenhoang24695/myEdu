...
<div class="controls row">
  <div class="col-sm-6">
    <label>
      <input type="radio" class="add_video_options" name="add_video_options" value="upload" checked="checked" /> Tải lên
    </label>
  </div>
  <div class="col-sm-6">
    <label>
      <input type="radio" class="add_video_options" name="add_video_options" value="library" /> Chọn từ thư viện
    </label>
  </div>
</div>
<div class="video_form form_upload">
  <div class="progress">
...
<div class="video_form form_library" style="display: none">
