                ...
                <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
                   <div class="box-body">
                        ...
                        <div class="col-sm-10">
                          <select class="form-control" name="parent">
                            ...
                            @foreach ($list as $key => $value)
                              <option {{ ($catebyid->blc_parent_id == $value->id) ? "selected":"" }} value="{{ $value->id }}">{{ $value->blc_title }}</option>
                            @endforeach
                          </select>
                     ...
                     <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                       ...
                       <div class="col-sm-10">
                         <input name="title" type="text" class="form-control" placeholder="Tên danh mục" value="{{ Request::old('title', $catebyid->blc_title) }}">
